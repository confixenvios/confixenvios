-- Fix RPC functions to return proper JSON format for the frontend

-- Drop existing functions
DROP FUNCTION IF EXISTS get_motorista_shipments(UUID);
DROP FUNCTION IF EXISTS get_available_shipments();

-- Recreate get_motorista_shipments function with proper JSON return
...
-- Recreate get_available_shipments function with proper JSON return
