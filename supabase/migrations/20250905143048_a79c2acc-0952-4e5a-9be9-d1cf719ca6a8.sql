-- Remover função existente e recriar com os campos necessários
DROP FUNCTION IF EXISTS public.get_motorista_shipments(uuid);

-- Criar função atualizada com todos os campos necessários
