-- Fix search_path for the new RPC functions by dropping and recreating them

-- Drop existing functions first
DROP FUNCTION IF EXISTS get_motorista_shipments(UUID);
DROP FUNCTION IF EXISTS get_available_shipments();

-- Recreate get_motorista_shipments function with search_path
...
-- Recreate get_available_shipments function with search_path
