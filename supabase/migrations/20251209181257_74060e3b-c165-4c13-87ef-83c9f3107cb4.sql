...
-- Recriar a função de autenticação com suporte a bcrypt
...
BEGIN
  ...
  -- crypt() gera o hash da senha de entrada usando o salt do hash armazenado
  -- Se os hashes coincidirem, a senha está correta
  password_valid := (motorista_record.senha = crypt(input_password, motorista_record.senha));
