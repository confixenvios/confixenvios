-- Fix search_path for the new RPC functions to resolve security warnings

-- Fix get_motorista_shipments function with search_path
...
-- Fix get_available_shipments function with search_path
