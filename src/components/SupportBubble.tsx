...
const SupportBubble = () => {
  ...
  // Hide on admin pages and ticket detail pages (to avoid covering the message input)
  const shouldHide = location.pathname.startsWith("/admin") || location.pathname.includes("/suporte/ticket/");
