...
import { Plus, Search, Ticket, Clock, CheckCircle2, AlertCircle, MessageCircle } from "lucide-react";
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Button onClick={() => navigate("/painel/suporte/novo")}>
      ...
      <Card className="bg-green-50 border-green-200">
        <CardContent className="p-4 flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-medium text-green-800">Atendimento via WhatsApp</p>
              <p className="text-sm text-green-600">Fale conosco para um atendimento mais rápido</p>
            </div>
          </div>
          <Button
            variant="outline"
            className="bg-green-600 text-white border-green-600 hover:bg-green-700"
            onClick={() => window.open("https://wa.me/5562987333276", "_blank")}
          >
        ...
        <div className="space-y-4">
          {filteredTickets.map((ticket) => (
            <Card
              ...
              onClick={() => navigate(`/painel/suporte/ticket/${ticket.id}`)}
            >
