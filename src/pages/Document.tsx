...
const Document = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // REMOVIDO: Webhook de CT-e não deve ser disparado antes do pagamento!
      // O webhook de CT-e agora é disparado APENAS em PaymentSuccessAsaas.tsx após confirmação do pagamento
