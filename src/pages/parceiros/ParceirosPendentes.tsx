...
const ParceirosPendentes = () => {
  ...
  const loadShipments = async () => {
    ...
    try {
      ...
      // Fetch addresses for each shipment
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Entregas aguardando coleta - {partner?.company_name}
          </p>
        </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <CardTitle className="flex items-center gap-2">
                ...
                Pendentes ({filteredShipments.length})
              </CardTitle>
              <CardDescription>Entregas aguardando coleta e processamento</CardDescription>
            </div>
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-12 text-muted-foreground">
              ...
              <p className="text-sm">Todas as entregas foram processadas</p>
            </div>
          ) : (
                    ...
                    <TableRow key={shipment.id}>
                      ...
                      <TableCell>
                        <Badge variant="secondary">
                          {shipment.status === 'paid' ? 'Pago' : 'Pendente'}
                        </Badge>
                      </TableCell>
