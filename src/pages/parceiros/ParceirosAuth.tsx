...
import { Loader2, ArrowLeft, Mail, Lock, Truck, Building2, Shield } from 'lucide-react';
...
const ParceirosAuth = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      // Authenticate using the secure function
      const { data, error } = await supabase.rpc('authenticate_carrier_partner', {
        p_email: email,
        p_password: password
      });
      ...
      const partner = data[0] as CarrierPartner;
      
      // Store partner data in sessionStorage
      sessionStorage.setItem('carrier_partner', JSON.stringify(partner));
      
      toast.success(`Bem-vindo, ${partner.company_name}!`);
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full p-12">
          ...
          <div className="mt-12 flex items-center gap-8 text-white/60">
            <div className="text-center">
              ...
              <p className="text-sm">Gestão de Entregas</p>
            </div>
            <div className="text-center">
