  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Entregas Realizadas</h1>
          <p className="text-muted-foreground">
            Entregas finalizadas - {partner?.company_name}
          </p>
        </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <CardTitle className="flex items-center gap-2">
                ...
                Realizadas ({filteredShipments.length})
              </CardTitle>
              <CardDescription>Entregas finalizadas com sucesso</CardDescription>
            </div>
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-12 text-muted-foreground">
              ...
              <p className="text-lg font-medium">Nenhuma entrega realizada</p>
              <p className="text-sm">Ainda não há entregas finalizadas</p>
            </div>
          ) : (
...
export default ParceirosRealizadas;